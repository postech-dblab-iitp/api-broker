...
static T_SERVER_FUNC server_fn_table[] = {
  fn_end_tran,			/* API_CAS_FC_END_TRAN */
  fn_prepare,			/* API_CAS_FC_PREPARE */
  fn_execute,			/* API_CAS_FC_EXECUTE */
  fn_not_supported,		/* API_CAS_FC_GET_DB_PARAMETER */
  fn_not_supported,		/* API_CAS_FC_SET_DB_PARAMETER */
  fn_close_req_handle,		/* API_CAS_FC_CLOSE_REQ_HANDLE */
  fn_cursor,			/* API_CAS_FC_CURSOR */
  fn_fetch,			/* API_CAS_FC_FETCH */
  fn_schema_info,		/* API_CAS_FC_SCHEMA_INFO */
  fn_not_supported,		/* API_CAS_FC_OID_GET */
  fn_not_supported,		/* API_CAS_FC_OID_SET */
  fn_not_supported,		/* API_CAS_FC_DEPRECATED1 */
  fn_not_supported,		/* API_CAS_FC_DEPRECATED2 */
  fn_not_supported,		/* API_CAS_FC_DEPRECATED3 */
  fn_get_db_version,		/* API_CAS_FC_GET_DB_VERSION */
  ...
  fn_not_supported,		/* API_CAS_FC_XA_PREPARE */
  fn_not_supported,		/* API_CAS_FC_XA_RECOVER */
  fn_not_supported,		/* API_CAS_FC_XA_END_TRAN */
  fn_con_close,			/* API_CAS_FC_CON_CLOSE */
  fn_check_cas,			/* API_CAS_FC_CHECK_CAS */
  fn_not_supported,		/* API_CAS_FC_MAKE_OUT_RS */
  fn_not_supported,		/* API_CAS_FC_GET_GENERATED_KEYS */
  fn_not_supported,		/* API_CAS_FC_LOB_NEW */
  fn_not_supported,		/* API_CAS_FC_LOB_WRITE */
  fn_not_supported,		/* API_CAS_FC_LOB_READ */
  fn_not_supported,		/* API_CAS_FC_END_SESSION */
  fn_not_supported,		/* API_CAS_FC_GET_ROW_COUNT */
  fn_not_supported,		/* API_CAS_FC_GET_LAST_INSERT_ID */
  fn_not_supported,		/* API_CAS_FC_PREPARE_AND_EXECUTE */
  fn_cursor_close,		/* API_CAS_FC_CURSOR_CLOSE */
	...
	if (net_read_stream (client_sock_fd, read_buf, db_info_size) < 0)
	...
	else
	  {
	    ...
	    if (DOES_CLIENT_UNDERSTAND_THE_PROTOCOL (req_info.client_version, PROTOCOL_V12))
	      {
		cas_bi_set_oracle_compat_number_behavior (0);
	      }
