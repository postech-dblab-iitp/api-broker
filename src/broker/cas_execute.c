...
connect_error:
  ...
  return ERROR_INFO_SET_WITH_MSG (s62_get_last_error (NULL), DBMS_ERROR_INDICATOR, "ux_database_connect error !!");
}
  ...
  if (stmt_id == NULL)
    {
      ...
      err_code = ERROR_INFO_SET (s62_get_last_error (NULL), DBMS_ERROR_INDICATOR);
      goto prepare_error;
    }
  else
    {
