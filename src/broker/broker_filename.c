...
get_cubrid_file (T_CUBRID_FILE_ID fid, char *buf, size_t len)
{
  ...
  switch (fid)
    ...
    case FID_CUBRID_BROKER_CONF:
      envvar_confdir_file (buf, len, "api_broker.conf");
      break;
    ...
    case FID_ADMIND_PID:
      ...
      break;
    case FID_SQL_LOG_DIR:
      envvar_logdir_file (buf, len, "api_broker/sql_log/");
      break;
    case FID_SQL_LOG2_DIR:
      envvar_logdir_file (buf, len, "api_broker/sql_log/query/");
      break;
    case FID_SLOW_LOG_DIR:
      envvar_logdir_file (buf, len, "api_broker/sql_log/");
      break;
    case FID_ADMIND_LOG:
      envvar_logdir_file (buf, len, "api_broker/sql_log/cas_admind.log");
      break;
    case FID_MONITORD_LOG:
      envvar_logdir_file (buf, len, "api_broker/sql_log/cas_monitord.log");
      break;
    case FID_CUBRID_ERR_DIR:
      envvar_logdir_file (buf, len, "api_broker/error_log/");
      break;
    case FID_ER_HTML:
